...
os.environ['KAGGLE_CONFIG_DIR'] = r'C:/Users/kaust/.kaggle'  # Update this path to your Kaggle configuration directory
# Specify the dataset identifier
dataset = 'piterfm/paris-2024-olympic-summer-games'
# Set the download path
download_path = r'C:\Users\kaust\Downloads\Olympic_Dashboard' # Change this to your preferred download directory
